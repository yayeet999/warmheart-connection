    ...
    <>
      ...
      {isMobile && (
        <button
          ...
          className="fixed left-4 top-4 z-50 p-2 rounded-full bg-white shadow-lg text-gray-500 hover:text-coral transition-all duration-300"
      ...
      <nav
        className={cn(
          "fixed left-0 top-0 h-full bg-white shadow-lg flex flex-col items-center py-8 transition-all duration-300 ease-in-out z-40",
