          ...
          <ScrollArea className="h-full">
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">1. Service Description and Purpose</h2>
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">2. Account Registration and Security</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">3. User Conduct and Acceptable Use</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">4. User Content and Monitoring</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">5. Subscriptions and Payments</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">7. Disclaimers of Warranty</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">9. Indemnification</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">10. Dispute Resolution and Arbitration</h2>
                <p className="text-charcoal/80 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-charcoal mb-4">11. Governing Law and Jurisdiction</h2>
                <p className="text-charcoal/80 mb-4">
