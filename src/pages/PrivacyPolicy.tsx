            ...
            <div className="prose prose-lg max-w-none prose-invert">
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc pl-6 text-gray-300 space-y-2">
                  <li><strong className="text-white/90">User Name:</strong> A display name or username you provide, used to personalize your experience in conversations.</li>
                  <li><strong className="text-white/90">Age Range:</strong> Your age range (we only allow 18+), used to ensure compliance with age restrictions and to tailor content appropriately.</li>
                  <li><strong className="text-white/90">Pronouns:</strong> The pronouns you provide (e.g., he/him, she/her, they/them), used for personalization so that Amorine refers to you correctly.</li>
                  <li><strong className="text-white/90">Email Address:</strong> Collected when you create an account or sign in (including via Google). This is used for account verification, login, password resets, and important communications about the Service.</li>
                  <li><strong className="text-white/90">Message History:</strong> The content of your conversations with Amorine. We store your chat history to provide context for future conversations and improve personalization.</li>
                </ul>
              </section>

              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">2. How We Use Your Information</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">3. Data Storage and Security</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">4. Third-Party Services</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">5. No Selling or Sharing of Personal Data</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">6. Your Rights and Choices</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">7. Account Deletion and Data Retention</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">8. International Users and Data Transfers</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">9. Children’s Privacy</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mb-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">10. Changes to this Privacy Policy</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section className="mt-12">
                <h2 className="text-2xl font-bold text-white/90 mb-4">11. Contact Us</h2>
                <p className="text-gray-300">
                  If you have any questions, concerns, or requests regarding this Privacy Policy or your personal data, please contact us at:
                </p>
                <div className="mt-4 p-6 bg-dark-200/80 rounded-xl border border-white/10">
